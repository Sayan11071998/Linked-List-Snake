...
namespace Player
{
	...
	SnakeController::SnakeController() { linked_list = nullptr; }
	...
	void SnakeController::render() { linked_list->render(); }
	...
	void SnakeController::updateSnakeDirection() { linked_list->updateNodeDirection(current_snake_direction); }

	void SnakeController::moveSnake() { linked_list->updateNodePosition(); }
	...
	int SnakeController::getSnakeSize() { return linked_list->getLinkedListSize(); }

	int SnakeController::getRandomBodyPartIndex() { return std::rand() % (linked_list->getLinkedListSize() - 1); }

	std::vector<sf::Vector2i> SnakeController::getCurrentSnakePositionList() { return linked_list->getNodePositionList(); }
	...
	void SnakeController::destroy() { delete linked_list; }
}